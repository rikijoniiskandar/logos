        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#get-started">Products</a></li>
    ...
    <main id="main">
        ...
        <section id="hero" class="hero section">
            @foreach ($heroes as $hero)
                <img src="{{ $hero->image }}" width="100%" alt="" data-aos="fade-in">
        ...
        <section id="get-started" class="padd-section text-center">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title text-center">
                    @if ($featured_product)
                        <h2>{{ $featured_product[0]->header }} </h2>
                        <p class="separator">{{ $featured_product[0]->subheader }}</p>
                    @endif
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    @if ($featured_product)
                        @if (is_array($featured_product[0]->content) || is_object($featured_product[0]->content))
                            @foreach ($featured_product[0]->content as $featured)
                                <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                                    <div class="feature-block">
                                        <img src="{{ asset($featured['image']) }}" alt="img">
        ...
        <section id="portofolios" class="padd-section text-center">
            ...
            <div class="container" data-aos="fade-up">
                <div class="section-title text-center">
                    <h2>Portofolio</h2>
                    <p class="separator">Beragam produk yang telah kami kerjakan .</p>
                </div>

                <div class="screens-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="assets/img/screen/1.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/screen/2.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/screen/3.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/screen/4.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/screen/5.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/screen/6.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/screen/7.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets/img/screen/8.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                        ...
                        <div class="col-md-9 col-lg-6">
                            <form class="d-flex" method="POST" action="#">
                                ...
                                <button type="submit" class="btn btn-default"><i
                                        class="bi bi-location-arrow"></i>Subscribe</button>
                            </form>
                        </div>
                    </div>
